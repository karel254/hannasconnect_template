...
export default function Home() {
  return (
    <>
      <Head>
        <title>Hanna's Connect - Clarity Before Chemistry</title>
        <meta
          name="description"
          content="Where meaningful connections begin. Join thousands finding authentic relationships."
        />
        <meta name="keywords" content="dating, relationships, connections, singles, love, compatibility" />
      </Head>
      <div className="h-screen w-screen fixed inset-0 overflow-hidden">
        ...
        <div className="relative z-10 h-full w-full flex flex-col justify-between">
          ...
          <div className="flex-1 flex flex-col justify-center items-center text-center px-6">
            ...
            <p className="text-xl sm:text-2xl text-white/90 font-light mb-8">Clarity Before Chemistry</p>
