...
export default function Messages() {
  ...
  const getMessages = (userId: string): Message[] => {
    const messageData: { [key: string]: Message[] } = {
      amara: [
        ...
        { id: 4, text: "A mobile app for a local restaurant. Really proud of how it turned out!", sender: "me", timestamp: "10:35 AM" },
        { id: 5, text: "That sounds like a great plan! I'd love to join you for coffee this weekend.", sender: "amara", timestamp: "10:40 AM" },
      ],
      kemi: [
        ...
        { id: 3, text: "Thanks for the book recommendation! I just started reading it.", sender: "kemi", timestamp: "1 hour ago" },
      ],
      david: [
      ...
      funmi: [
        { id: 1, text: "Hope you're having a great day! 😊", sender: "funmi", timestamp: "Yesterday" },
      ],
      tunde: [
  ...
  return (
    <div className="h-screen bg-gray-50 dark:bg-gray-900 flex overflow-hidden">
      {/* Contacts List */}
      <div className={`${selectedUser ? "hidden md:flex" : "flex"} flex-col w-full md:w-80 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 overflow-hidden`}>
        ...
        <div className="flex-1 flex flex-col bg-white dark:bg-gray-800 overflow-hidden">
            ...
            {messages.map((msg) => (
              <div key={msg.id} className={`flex ${msg.sender === "me" ? "justify-end" : "justify-start"}`}>
                <div className={`flex items-end space-x-2 max-w-xs lg:max-w-md ${msg.sender === "me" ? "flex-row-reverse space-x-reverse" : ""}`}>
                  ...
                  <div className={`px-4 py-2 rounded-2xl ${msg.sender === "me" ? "bg-[#B22222] text-white rounded-br-md" : "bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-bl-md"}`}>
                    <p className="text-sm">{msg.text}</p>
                    <p className={`text-xs mt-1 ${msg.sender === "me" ? "text-white/70" : "text-gray-500 dark:text-gray-400"}`}>
                      {msg.timestamp}
                    </p>
                  </div>
                </div>
          ...
          <div className="flex-shrink-0 p-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
            <div className="flex items-center space-x-2">
              ...
              />
              <Button onClick={handleSendMessage} disabled={!message.trim()} className="bg-[#B22222] hover:bg-[#8B0000] text-white rounded-xl px-4">
